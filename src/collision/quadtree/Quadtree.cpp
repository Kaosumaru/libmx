...
QuadtreeWeakLayeredArea::QuadtreeWeakLayeredArea(const MX::Rectangle &rect, bool excludeShapesOutsideBounds) : _rectangle(rect), _excludeShapesOutsideBounds(excludeShapesOutsideBounds)
{
}


QuadtreeWeakLayeredArea::QuadtreeWeakLayeredArea(float width, float height, bool excludeShapesOutsideBounds) : _rectangle(0, 0, width, height), _excludeShapesOutsideBounds(excludeShapesOutsideBounds)
{
