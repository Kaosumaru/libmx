...
public:
    ...
    NotifierActorDecorator(const Function& f)
        : _f(f)
    {
    }
...
public:
    ...
    ActorDecoratorScripts(LScriptObject& script)
        : ActorDecorator(script)
    {
...
public:
    ...
    ActorDecoratorGeometry(LScriptObject& script)
        : ActorDecorator(script)
    {
...
public:
    ...
    ActorDecoratorPositionInFactory(LScriptObject& script)
        : ActorDecorator(script)
    {
