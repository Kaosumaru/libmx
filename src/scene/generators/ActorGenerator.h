...
{
public:
    ActorGeneratorMax(LScriptObject& script)
        : ActorGenerator(script)
    {
    }
...
{
public:
    ActorGeneratorSimple(LScriptObject& script)
        : ActorGenerator(script)
    {
...
public:
    ...
    ActorGeneratorRandomIntervals(LScriptObject& script)
        : ActorGenerator(script)
    {
...
{
public:
    ActorGeneratorIncremental(LScriptObject& script)
        : ActorGenerator(script)
    {
