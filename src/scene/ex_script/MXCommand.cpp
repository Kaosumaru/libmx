...
ScriptSignal& ScriptSignal::operator = (const MX::Scriptable::Value &value) { ScriptHolder::operator=(value); return *this; }
ScriptSignal& ScriptSignal::operator += (const MX::Scriptable::Value &value) { ScriptHolder::operator+=(value); return *this; }
ScriptSignal& ScriptSignal::operator += (const ScriptHolder &value) { ScriptHolder::operator+=(value); return *this; }
