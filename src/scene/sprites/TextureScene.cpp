...
TextureDisplaySceneTimer::TextureDisplaySceneTimer(const glm::vec2& size)
    : DisplaySceneTimer(size)
{
...
TextureScene::TextureScene(const glm::vec2& size, const Color& backgroundColor, bool alpha)
...
ScrollableTextureScene::ScrollableTextureScene(const glm::vec2& viewDimensions, const glm::vec2& sceneDimensions)
    : TextureScene(viewDimensions)
    , ScrollableSpriteScene(viewDimensions, sceneDimensions)
{
}
