...
protected:
    ...
    {
        FunctorEntry(const typename Signal::Function& func)
            : _func(func)
        {
        }
    ...
    {
        FunctorEntryExtended(const typename Signal::FunctionExtended& func)
            : _func(func)
        {
        }
    ...
    {
        FunctorEntryWeakExtended(const typename Signal::FunctionExtended& func, const std::weak_ptr<T>& ptr)
            : FunctorEntry(func)
            , _ptr(ptr)
        {
        }
...
protected:
    struct FunctorEntry
    {
        FunctorEntry(const typename SimpleSignal::Function& func)
            : _func(func)
        {
        }
        virtual bool Do(Args&&... arg)
    ...
    struct FunctorEntryWeak : public FunctorEntry
    {
        FunctorEntryWeak(const typename SimpleSignal::Function& func, const std::weak_ptr<T>& ptr)
            : FunctorEntry(func)
            , _ptr(ptr)
        {
        }
