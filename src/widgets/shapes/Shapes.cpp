...
public:
    ScriptShapePolicy() { }
    ScriptShapePolicy(const ScriptShapePolicy& other)
        : ScriptObject(other)
    {
    }
...
public:
    ScriptCirclePolicy() { }
    ScriptCirclePolicy(const ScriptCirclePolicy& other)
        : ScriptShapePolicy(other)
    {
    }
...
public:
    ...
    ScriptPolygonShapePolicy(const ScriptPolygonShapePolicy& other)
        : ScriptShapePolicy(other)
    {
