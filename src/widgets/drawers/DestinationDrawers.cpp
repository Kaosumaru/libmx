...
struct DestinationProperty
{
    ...
    DestinationProperty(float v = 0.0f)
        : _value(v)
    {
    }
...
{
public:
    DrawerWithChildren(MX::LScriptObject& script)
        : Drawer(script)
    {
...
{
protected:
    DestinationBaseDrawer(MX::LScriptObject& script, bool useWH = true)
        : DrawerWithChildren(script)
    {
...
{
public:
    ClipDrawer(LScriptObject& script)
        : DestinationBaseDrawer(script)
    {
    }
...
{
public:
    DestinationDrawer(LScriptObject& script, bool useWH = true)
        : DestinationBaseDrawer(script, useWH)
    {
    }
...
{
public:
    ShiftDrawer(LScriptObject& script)
        : DrawerWithChildren(script)
    {
...
{
public:
    TransformDrawer(LScriptObject& script)
        : DestinationDrawer(script)
    {
...
{
public:
    RepeatDrawer(LScriptObject& script)
        : DestinationDrawer(script)
    {
...
{
public:
    TableDataDrawer(LScriptObject& script, bool useWH = true)
        : DestinationDrawer(script, useWH)
    {
...
{
public:
    TableDrawer(LScriptObject& script, bool useWH = true)
        : TableDataDrawer(script, useWH)
    {
        GatherChildren();
    }
...
{
public:
    TRDrawer(LScriptObject& script)
        : TableDrawer(script, false)
    {
        _vertical = true;
