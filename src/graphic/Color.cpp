...
ColorExtended::ColorExtended(const unsigned& argb_color)
    : _original(argb_color)
    , _current(_original)
{
}
ColorExtended::ColorExtended(unsigned char r, unsigned char g, unsigned char b)
    : _original(r, g, b)
    , _current(_original)
{
}
ColorExtended::ColorExtended(unsigned char r, unsigned char g, unsigned char b, unsigned char a)
    : _original(r, g, b, a)
    , _current(_original)
{
}

ColorExtended::ColorExtended(float r, float g, float b)
    : _original(r, g, b)
    , _current(_original)
{
}
ColorExtended::ColorExtended(float r, float g, float b, float a)
    : _original(r, g, b, a)
    , _current(_original)
{
}
