...
public:
	ParticleGenerator() {}
	ParticleGenerator(const std::string& objectName) : ScriptObjectString(objectName) {}
...
{
public:
	ParticleGeneratorSimple(float perSecond) : _particle_time(1.0f/perSecond)
	{
		_time = 0.0f;
	}

	ParticleGeneratorSimple(const std::string& objectName) : ParticleGenerator(objectName) 
	{
...
{
public:
	ParticleGeneratorAllAtOnce(const std::string& objectName) : ParticleGenerator(objectName)
	{
