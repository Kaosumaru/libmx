...
namespace Graphic
{
    ...
    public:
        ParticleEmitter() { }
        ParticleEmitter(const std::string& objectName)
    ...
    public:
        ParticleEmitterBase() { }
        ParticleEmitterBase(const std::string& objectName)
            : ParticleEmitter(objectName)
        {
    ...
    {
    public:
        PointParticleEmitter(const std::string& objectName)
            : ParticleEmitterBase(objectName)
        {
    ...
    {
    public:
        PointRotationParticleEmitter(const std::string& objectName)
            : ParticleEmitterBase(objectName)
        {
    ...
    {
    public:
        PointGaussParticleEmitter(const std::string& objectName)
            : ParticleEmitterBase(objectName)
        {
            load_property(_direction, "Direction");
            _direction.first *= (float)MX_2PI;
    ...
    {
    public:
        CircleParticleEmitter(const std::string& objectName)
            : PointParticleEmitter(objectName)
        {
    ...
    {
    public:
        CircumferenceParticleEmitter(const std::string& objectName)
            : CircleParticleEmitter(objectName)
        {
        }
    ...
    {
    public:
        CircleRotationParticleEmitter(const std::string& objectName)
            : ParticleEmitterBase(objectName)
        {
            load_property(_direction_range, "Direction");
            _direction_range.first *= (float)MX_2PI;
