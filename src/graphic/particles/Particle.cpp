...
{
public:
    ParticleImageCreator(const std::string& objectName)
        : ParticleCreator(objectName)
    {
...
{
public:
    ParticleRandomImageCreator(const std::string& objectName)
        : ParticleCreator(objectName)
    {
...
{
public:
    ParticleImageFlying(const std::shared_ptr<Graphic::Image>& image)
        : ParticleImage(image)
    {
    }
...
{
public:
    ParticleImageFlyingCreator(const std::string& objectName)
        : ParticleCreator(objectName)
    {
        load_property(_animation, "Animation");
        load_property(_image, "Image");
